 ...
 */
package com.web2.MVSSpring.controladores;

import com.web2.MVSSpring.modelos.Producto;
import com.web2.MVSSpring.repositorio.RepositorioProducto;
...
public class ProductoControlador {
    ...
    public String guardar(@RequestParam String prodNombre, @RequestParam String prodDesc, @RequestParam String prodImagen, @RequestParam Double prodPrecio) {
    ...
    public String modificar(@RequestParam Long id, @RequestParam String prodNombre, @RequestParam String prodDesc, @RequestParam Double prodPrecio, @RequestParam String prodImagen) {
        Producto producto = repositorioProducto.findById(id).orElse(null);
        producto.setProdNombre(prodNombre);
        producto.setProdDesc(prodDesc);
        producto.setProdImagen(prodImagen);
